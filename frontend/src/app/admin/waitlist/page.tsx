              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 pr-10 text-sm text-white focus:outline-none focus:ring-2 focus:ring-[#4A9B3F]/50"
                    autoComplete="new-password"
                  />
                  <button
                    type="button"
                    aria-label={showProvisionPassword ? "Hide password" : "Show password"}
                    onClick={() => setShowProvisionPassword((v) => !v)}
