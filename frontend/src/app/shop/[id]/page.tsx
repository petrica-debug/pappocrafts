          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-2 text-charcoal/60">
                Handcrafted by <strong className="text-charcoal">{product.artisan}</strong>
              </p>

              <p className="mt-6 text-3xl font-bold text-green">&euro;{product.price.toFixed(2)}</p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4 border-t border-charcoal/10 pt-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-charcoal/60">Free shipping over &euro;75</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 text-green" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
                  </svg>
                  <span className="text-sm text-charcoal/60">Authenticity guaranteed</span>
                </div>
              </div>
            </div>
          </div>
                ...
                {related.map((p) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs text-charcoal/50 mt-0.5">by {p.artisan} &middot; {p.country}</p>
                      <p className="mt-2 text-lg font-bold text-green">&euro;{p.price.toFixed(2)}</p>
                    </div>
                  </Link>
                ))}
              </div>
